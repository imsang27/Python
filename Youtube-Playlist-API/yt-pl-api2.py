...
# 2024-10-04
# https://www.youtube.com/playlist?list=PLGvD-qQNEzS8AqkIceGZp_R63WTwraNXD
...
# API 키와 재생목록 ID 설정
playlist_url = r"https://www.youtube.com/playlist?list=PLGvD-qQNEzS8AqkIceGZp_R63WTwraNXD"  # r(읽기 모드)로 실행.
api_key = "AIzaSyAL8Lukv9OugLxENDC1FOWoQMW-GLcOyWg"
